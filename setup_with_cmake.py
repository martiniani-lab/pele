...
setup(
    ...
    data_files=[
        ("pele/potentials/tests", list(glob.glob("pele/potentials/tests/*.xyz"))),
...
def set_compiler_env(compiler_id):
    ...
    cmake_compiler_args = shlex.split(
        "-DCMAKE_EXPORT_COMPILE_COMMANDS=1 -D CMAKE_C_COMPILER={} -D"
        " CMAKE_CXX_COMPILER={} -D CMAKE_LINKER={} -D CMAKE_AR={}".format(
