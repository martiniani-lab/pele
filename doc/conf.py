...
project = "pele"
copyright = "2017, Johannes Klicpera, Victor Rühle, Jacob Stevenson"
...
latex_documents = [
    (
        ...
        "pele.tex",
        "pele Documentation",
        "Johannes Klicpera, Victor Rühle, Jacob Stevenson",
        "manual",
    ),
]
...
def linkcode_resolve(domain, info):
    ...
    return "http://github.com/pele-python/pele/blob/master/pele/%s%s" % (fn, linespec)
