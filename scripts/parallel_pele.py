...
def main():
    ...
    parser.add_argument(
        "--server", action="store_true", help="start the server"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--connect", action="store_true", help="start a connect run"
    )
    parser.add_argument(
        "--uri", type=str, default=None, help="uri of the server"
    )
    parser.add_argument(
        "--host",
        type=str,
    ...
    mod = __import__(
        args.system_file, globals(), locals(), ["create_system"], -1
    )
