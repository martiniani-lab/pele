...
binary data.  If your coordinates are garbage, try changing the endianness.
    ...
    parser.add_argument(
        "--ndof",
        help="Number of total degrees of freedom (e.g. 3*number of atoms).  This is simply the length of a coordinates vector.",
        type=int,
        default=None,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--endianness",
        help='set the endianness of the binary data.  Can be "<" for little-endian or ">" for big-endian',
        type=str,
        default="=",
    )
