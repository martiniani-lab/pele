 ...
 * @brief Mixed descent that switches to newton only at the end of the optimization.
 * @version 0.1
 * @date 2021-11-05
 * 
...
namespace pele {
    ...
    class MixedDescentEndOnly : public GradientOptimizer {
        ...
        void one_iteration();
        // since most of the calculations are done in the attached optimizers, we defer the calculations to them
        inline int get_nhev() { 
