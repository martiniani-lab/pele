...
public:
  ...
  MatrixAdapter(size_t dim1, size_t dim2, dtype val = 0)
      : pele::Array<dtype>(dim1 * dim2, val), _dim2(dim2) {}
  ...
  MatrixAdapter(double *data, size_t dim1, size_t dim2)
      : pele::Array<dtype>(data, dim1 * dim2), _dim2(dim2) {}
...
MatrixAdapter<dtype> hacky_mat_mul(MatrixAdapter<dtype> const &A,
...
// */
// template<class dtype>
// pele::Array<dtype> hacky_mat_mul(MatrixAdapter<dtype> const & A,
// pele::Array<dtype> const & v)
//{
