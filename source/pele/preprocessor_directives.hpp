 ...
 *       LEVEL 2: Information per iteration of the optimizer. (helpful to set
 * for a single run of the optimizer) LEVEL 3: Information within loops of the
 * iteration. Example line search iterations. (helpful to set for a single run
 * of the optimizer) LEVEL 0: no information
 *
