 ...
 * polynomial.
 */
struct lj_interaction_cut_smooth : BaseInteraction {
  ...
  lj_interaction_cut_smooth(double C6, double C12, double rcut)
      : _C6(C6),
        ...
        _A2(-3. * _C6 / (_rcut2 * _rcut2 * _rcut2 * _rcut2) +
            6. * _C12 /
                (_rcut2 * _rcut2 * _rcut2 * _rcut2 * _rcut2 * _rcut2 * _rcut2)),
        _2A2(2. * _A2) {}
 ...
 public:
  LJCutPeriodicAtomList(double C6, double C12, double rcut,
      ...
      : AtomListPotential<lj_interaction_cut_smooth, periodic_distance<3>>(
            std::make_shared<lj_interaction_cut_smooth>(C6, C12, rcut),
            std::make_shared<periodic_distance<3>>(boxvec), atoms1, atoms2) {}
