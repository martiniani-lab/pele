...
class Newton : public GradientOptimizer {
    ...
    public:
    /**
     * @brief Newton method that ignores singular while calculating the inverse. Uses a backtracking linesearch.
     *        If the hessian has singular values uses the minimum norm solution for solving the inverse.
     * 
