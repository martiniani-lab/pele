...
pele::VecN<4> quaternion_multiply(pele::VecN<4> const &q1,
                                  pele::VecN<4> const &q2);
/**
 * change angle axis rotation p1 by the rotation p2
 */
inline pele::VecN<3> rotate_aa(pele::VecN<3> const &p1,
                               pele::VecN<3> const &p2) {
  return pele::quaternion_to_aa(pele::quaternion_multiply(
      pele::aa_to_quaternion(p2), pele::aa_to_quaternion(p1)));
}
 ...
 */
void rot_mat_derivatives(pele::VecN<3> const &p, pele::MatrixNM<3, 3> &rmat,
