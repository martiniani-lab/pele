...
bool GenericMixedDescent::x_in_convex_region() {
  ...
  // Ideally you should be able to get the pointer to the hessian from the optimizer.
  get_hess(hessian_);
  ...
  // 1 is the length of the uplo string, necessary for current fortran compilers.
