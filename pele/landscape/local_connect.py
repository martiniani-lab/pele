...
def _refineTS(
    pot, coords, tsSearchParams=None, eigenvec0=None, pushoff_params=None
):
    """
...
class LocalConnect(object):
    ...
    def _doNEB(self, minNEB1, minNEB2, repetition=0):
        ...
        dist, newcoords1, newcoords2 = self.mindist(
            minNEB1.coords, minNEB2.coords
        )
        logger.info("")
