...
class MeasurePeriodic(MeasurePolicy):
    ...
    def __init__(self, box_lengths, permlist=None):
        ...
        self.iboxlengths = 1.0 / self.boxlengths
    ...
    def find_permutation(self, X1, X2):
        return find_best_permutation(
            X1, X2, self.permlist, box_lengths=self.boxlengths
        )

    def get_com(self, X):
        raise NotImplementedError(
            "Center of mass not defined for periodic systems"
        )
...
class ExactMatchPeriodic(object):
    ...
    def __init__(self, measure, accuracy=0.01):
