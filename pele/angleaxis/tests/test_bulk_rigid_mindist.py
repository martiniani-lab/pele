...
from pele.angleaxis.aaperiodicttransforms import (ExactMatchRigidPeriodic,
...
class TestExactMatchPeriodicRigid(unittest.TestCase):
    ...
    def get_random_configuration(self):
        ...
        for i in range(self.nrigid):
            for j in range(3):
                x[i][j] = np.random.uniform(-self.boxl[j] / 2.0, self.boxl[j] / 2.0)
    ...
    def test_align_translate(self):
        ...
        self.assertFalse(
            fail_counter, "bond lengths were changed %d times" % fail_counter
        )
    ...
    def test_align_match(self):
        ...
        for i in range(1):
            ...
            if dist > 1e-5:
                ...
                print(dist)
        self.assertFalse(
            fail_counter, "structure matching failed %d times" % fail_counter
        )
    ...
    def test_align_permutation(self):
        ...
        for i in range(1):
            ...
            try:
                ...
                fail_counter += 1
        self.assertFalse(
            fail_counter, "rotational alignment failed %d times" % fail_counter
        )
        ...
        for i in range(max_step):
            ...
            if dist2 > dist:
                ...
                try:
                    ...
                    pym.draw_rigid(
                        self.x2diff, "B", 0.1, (0, 1, 0), self.system.draw_bonds
                    )
