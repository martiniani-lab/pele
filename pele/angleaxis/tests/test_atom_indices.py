...
from pele.angleaxis.rigidbody import \
    RBPotentialWrapper as pythonRBPotentialWrapper
...
class TestAtomIndices(unittest.TestCase):
    ...
    def get_random_rbcoords(self):
        ...
        ret = otp.get_random_minimized_configuration(tol=100.0)
        return ret.coords
    ...
    def test_transform_gradient(self):
        ...
        assert_arrays_almost_equal(
            self, gai.reshape(-1, 3)[atom_indices], gnorm.reshape(-1, 3)
        )
