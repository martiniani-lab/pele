...
from pele.transition_states._find_lowest_eig import (
    FindLowestEigenVector, analyticalLowestEigenvalue, findLowestEigenVector)
...
class TestFindLowestEigenvector(unittest.TestCase):
    ...
    def setUp1(self, **kwargs):
        ...
        self.x = self.system.get_random_minimized_configuration(tol=100.0).coords
