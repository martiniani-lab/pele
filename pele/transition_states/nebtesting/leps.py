    ...
    def getEnergy(self, r):
        ...
        def Q(d, r):
            return old_div(
                d
                * (
                    old_div(3 * numpy.exp(-2 * alpha * (r - r0)), 2)
                    - numpy.exp(-alpha * (r - r0))
                ),
                2,
            )
        ...
        def J(d, r):
            return old_div(
                d
                * (numpy.exp(-2 * alpha * (r - r0)) - 6 * numpy.exp(-alpha * (r - r0))),
                4,
            )
    ...
    def getEnergyGradient(self, r):
        ...
        def dQ(d, r):
            return old_div(
                ...
                * d
                * (
                    -3 * numpy.exp(-2 * alpha * (r - r0)) + numpy.exp(-alpha * (r - r0))
                ),
                2,
            )
        ...
        def dJ(d, r):
            return old_div(
                ...
                * d
                * (
                    -2 * numpy.exp(-2 * alpha * (r - r0))
                    + 6 * numpy.exp(-alpha * (r - r0))
                ),
                4,
            )
