...
class TestDB(unittest.TestCase):
    ...
    def test_energy(self):
        m = self.db.minima()[0]
        self.assertEqual(m.energy, 0.0)

    def test_coords(self):
        m = self.db.minima()[0]
        self.assertEqual(m.coords, [0.0])
    ...
    def test_energyts(self):
        ...
        self.assertEqual(ts.energy, 0.0)

    def test_coordsts(self):
        ts = self.db.transition_states()[0]
        self.assertEqual(ts.coords, [0.0])
    ...
    def test_maximum_number_of_minima(self):
        m = self.db.addMinimum(-1.0, [-1.0], max_n_minima=self.nminima)
        self.assertEqual(self.nminima, self.db.number_of_minima())
    ...
    def test_property(self):
        ...
        self.assertTrue(dict(natoms=10).items() <= props.items())
