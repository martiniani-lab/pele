...
def generate_initial_conditions_and_potential(n_part, seed=0):
    ...
    ncellx_scale = get_ncellsx_scale(
        radii, [box_length, box_length], omp_threads=None
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--n_particles", type=int, default=16, help="Number of particles"
    )
    parser.add_argument(
        "--n_ensemble", type=int, default=10, help="Number of ensembles"
    )
