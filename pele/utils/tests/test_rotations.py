...
from pele.utils.rotations import (mx2q, q2aa, q2mx, q_multiply, random_aa,
                                  random_q)
...
class TestRotations(unittest.TestCase):
    ...
    def test_mx2q_fork1(self):
        mx = np.array(
            [
                [0.84678162, 0.50684295, 0.16146551],
    ...
    def test_mx2q_fork2(self):
        mx = np.array(
            [
                [0.60801609, -0.66494404, 0.43378088],
    ...
    def test_mx2q_fork3(self):
        mx = np.array(
            [
                [-0.44019684, -0.78441865, -0.43693721],
    ...
    def test_mx2q_fork4(self):
        mx = np.array(
            [
                [-0.16802893, -0.42028749, -0.89169765],
