...
from simtk.openmm.app import AmberInpcrdFile, AmberPrmtopFile, Simulation
from simtk.unit import (angstrom, kilocalories_per_mole, kilojoules_per_mole,
...
class OpenMMAmberPotential(BasePotential):
    ...
    def getEnergyGradient(self, coords):
        ...
        grad = old_div(
            -forcee, (old_div(kilojoules_per_mole, nanometer)) / 10 / self.kJtokCal
