    ...
    for each in inp:
        ...
        if (els[0] != "END") and (each[22:26].strip() == prev) and (prev != 1):
            ...
            #      atnum3.append(ATMlist[15].index)
                ...
                ATMlist[0].acidname == "HIS"
                or ATMlist[0].acidname == "HIE"
                or ATMlist[0].acidname == "HID"
                or ATMlist[0].acidname == "HIP"
                or ATMlist[0].acidname == "HSD"
                or ATMlist[0].acidname == "HSE"
                or ATMlist[0].acidname == "HSP"
            ):
                atnum.append(ATMlist[5].index)
                atnum.append(ATMlist[6].index)
            elif (
                ATMlist[0].acidname == "NHIS"
                or ATMlist[0].acidname == "NHIE"
                or ATMlist[0].acidname == "NHID"
                or ATMlist[0].acidname == "NHIP"
                or ATMlist[0].acidname == "NHSD"
                or ATMlist[0].acidname == "NHSE"
                or ATMlist[0].acidname == "NHSP"
            ):
                atnum.append(ATMlist[7].index)
                atnum.append(ATMlist[8].index)
                count2 = 3
                ...
                ATMlist[0].acidname == "CHIS"
                or ATMlist[0].acidname == "CHIE"
                or ATMlist[0].acidname == "CHID"
                or ATMlist[0].acidname == "CHSE"
                or ATMlist[0].acidname == "CHSD"
            ):
                atnum.append(ATMlist[5].index)
                atnum.append(ATMlist[6].index)
                count2 = 2
            ...
            #####################
                ...
                ATMlist[0].acidname == "RA"
                or ATMlist[0].acidname == "RA3"
                or ATMlist[0].acidname == "RC"
                or ATMlist[0].acidname == "RC3"
            ):
                atnum.append(ATMlist[1].index)
                atnum.append(ATMlist[2].index)
                count2 = 2
                ...
                ATMlist[0].acidname == "RA5"
                or ATMlist[0].acidname == "RAN"
                or ATMlist[0].acidname == "RC5"
                or ATMlist[0].acidname == "RCN"
            ):
                atnum.append(ATMlist[3].index)
                atnum.append(ATMlist[4].index)
                count2 = 2
                ...
                atnum2.append(ATMlist[5].index)
                atnum2.append(ATMlist[6].index)
            elif (ATMlist[0].acidname == "RU5") or (
                ATMlist[0].acidname == "RUN"
            ):
                atnum.append(ATMlist[3].index)
                atnum.append(ATMlist[4].index)
            else:
                print(
                    "Neither amino acid nor nucleic residue - please check residue %s"
                    % ATMlist[0].acidname
                )
