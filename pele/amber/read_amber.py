...
def create_molecule(topology_data):
    ...
    first_atoms = [(old_div(x, 3)) + 1 for x in topology_data["BONDS_INC_HYDROGEN"][0::3] + topology_data["BONDS_WITHOUT_HYDROGEN"][0::3]]
    second_atoms = [(old_div(x, 3)) + 1 for x in topology_data["BONDS_INC_HYDROGEN"][1::3] + topology_data["BONDS_WITHOUT_HYDROGEN"][1::3]]
