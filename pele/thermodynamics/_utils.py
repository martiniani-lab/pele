...
class _ThermoWorker(
    ...
    def __init__(
        self, input_queue, output_queue, system, verbose=False, **kwargs
    ):
    ...
    def process_input(self):
        ...
        if self.verbose:
            print(
                "finished computing thermodynamic info for minimum",
                mid,
                pgorder,
                fvib,
            )
...
def get_thermodynamic_information_minimum(
    system, database, minimum, commit=True
):
    m = minimum
    changed = False
...
def get_thermodynamic_information(
    ...
    try:
        for m in database.minima():
            c = get_thermodynamic_information_minimum(
                system, database, m, commit=False
            )
            if c:
                changed = True
