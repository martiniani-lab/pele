...
class MainGUI(QtGui.QMainWindow):
    ...
    def get_selected_coords(self):
        ...
        """
        coords1, coords2 = (
            self.minima_selection.coords1,
            self.minima_selection.coords2,
        )
    ...
    def show_TS(self, ts):
        ...
        if self.usepymol:
            self.pymolviewer.update_coords(
                self.tscoordspath, index=1, delete_all=True
            )
    ...
    def on_btnAlign_clicked(self, clicked=None):
        ...
        print(
            "energy before alignment",
            pot.getEnergy(coords1),
    ...
    def on_btnNEB_clicked(self, clicked=None):
        ...
        if not hasattr(self, "nebexplorer"):
            self.nebexplorer = NEBExplorer(
                system=self.system, app=self.app, parent=self
            )
    ...
    def on_btnShowGraph_clicked(self, clicked=None):
        ...
        if not hasattr(self, "graphview"):
            self.graphview = GraphViewDialog(
                self.system.database, parent=self, app=self.app
            )
    ...
    def on_btn_connect_all_clicked(self, checked=None):
        ...
        self.connect_all = ConnectAllDialog(
            self.system, self.system.database, parent=self, app=self.app
        )
        self.connect_all.show()
    ...
    def compute_thermodynamic_information(self, on_finish=None):
        ...
        print(
            "calculating thermodynamics for",
            njobs,
    ...
    def on_btn_rates_clicked(self, clicked=None):
        ...
        if not hasattr(self, "rate_viewer"):
            m1, m2 = (
                self.minima_selection.minimum1,
                self.minima_selection.minimum2,
            )
            self.rate_viewer = RateViewer(
                self.system, self.system.database, parent=self
            )
            if m1 is not None:
