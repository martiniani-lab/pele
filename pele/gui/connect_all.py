...
class _ConnectAttempt(object):
    ...
    def __init__(
        self, min1, min2, success, minima, transition_states, elapsed_time=None
    ):
        self.min1 = min1
        self.min2 = min2
...
class _ConnectAllSummary(object):
    ...
    def add(self, min1, min2, success, minima, transition_states, **kwargs):
        attempt = _ConnectAttempt(
            min1, min2, success, minima, transition_states, **kwargs
        )
    ...
    def get_summary(self):
        ...
        summary += "%d successes %d failures\n" % (
            len(successes),
            len(self.attempts) - len(successes),
        )
...
class ConnectAllDialog(ConnectViewer):
    ...
    def __init__(self, system, database, parent=None, app=None):
        ...
        self.view_dgraph = self.new_view(
            "Disconnectivity Graph", self.wgt_dgraph, QtCore.Qt.TopDockWidgetArea
        )
...
if __name__ == "__main__":
    ...
    from pele.systems import BLJCluster, LJCluster
