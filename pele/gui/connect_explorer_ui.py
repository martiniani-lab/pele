...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(
            self.wgt_ogl_slider.sizePolicy().hasHeightForWidth()
        )
        ...
        self.formLayout.setWidget(
            2, QtGui.QFormLayout.LabelRole, self.btn_show_neb_path
        )
        ...
        QtCore.QObject.connect(
            self.btn_show_ts_path,
            QtCore.SIGNAL(_fromUtf8("clicked()")),
            Form.show_TS_path,
        )
        QtCore.QObject.connect(
            self.btn_show_neb_path,
            QtCore.SIGNAL(_fromUtf8("clicked()")),
            Form.show_neb_path,
        )
        QtCore.QObject.connect(
            self.btn_show_pushoff,
            QtCore.SIGNAL(_fromUtf8("clicked()")),
            Form.show_pushoff_path,
        )
        QtCore.QObject.connect(
            self.btn_refineTS,
            QtCore.SIGNAL(_fromUtf8("clicked()")),
            Form.on_refine_transition_state,
        )
        QtCore.QObject.connect(
            self.list_ts,
            QtCore.SIGNAL(
                _fromUtf8("currentItemChanged(QListWidgetItem*,QListWidgetItem*)")
            ),
            Form.on_list_ts_selected,
        )
        QtCore.QObject.connect(
            self.pushButton,
            QtCore.SIGNAL(_fromUtf8("clicked()")),
            Form.on_refine_all_ts,
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_refineTS.setText(
            QtGui.QApplication.translate(
                "Form", "refine transition state", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.btn_show_neb_path.setText(
            QtGui.QApplication.translate(
                "Form", "show NEB path", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.btn_show_ts_path.setText(
            QtGui.QApplication.translate(
                "Form",
                "show TS refinement trajectory",
                None,
                QtGui.QApplication.UnicodeUTF8,
            )
        )
        self.btn_show_pushoff.setText(
            QtGui.QApplication.translate(
                "Form", "show pushoff path", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.pushButton.setText(
            QtGui.QApplication.translate(
                "Form", "refine all", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.label.setText(
            QtGui.QApplication.translate(
                "Form", "Transition states found", None, QtGui.QApplication.UnicodeUTF8
            )
        )
