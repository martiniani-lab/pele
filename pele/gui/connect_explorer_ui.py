...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(
            self.wgt_neb.sizePolicy().hasHeightForWidth()
        )
        ...
        self.formLayout.setWidget(
            0, QtGui.QFormLayout.LabelRole, self.btn_refineTS
        )
        ...
        self.formLayout.setWidget(
            3, QtGui.QFormLayout.LabelRole, self.btn_show_ts_path
        )
        self.btn_show_pushoff = QtGui.QPushButton(Form)
        self.btn_show_pushoff.setObjectName(_fromUtf8("btn_show_pushoff"))
        self.formLayout.setWidget(
            4, QtGui.QFormLayout.LabelRole, self.btn_show_pushoff
        )
        self.pushButton = QtGui.QPushButton(Form)
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.formLayout.setWidget(
            1, QtGui.QFormLayout.LabelRole, self.pushButton
        )
