...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(
            1, QtGui.QFormLayout.LabelRole, self.btn_recalculate
        )
