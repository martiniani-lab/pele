...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.view3D.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionShow_energies.setToolTip(
            QtGui.QApplication.translate(
                "MainWindow",
                "<html><head/><body><p>Show a plot of the energies.  Note the energy will only agree with the harmonic approximation if the metric tensor is the identity.  Click the button &quot;Hessian eigs&quot; to make the energies agree.</p></body></html>",
                None,
                QtGui.QApplication.UnicodeUTF8,
            )
        )
        ...
        self.actionHessian_eigs.setToolTip(
            QtGui.QApplication.translate(
                "MainWindow",
                "<html><head/><body><p>Show the Hessian eigenvalues and eigenvectors instead of the normal modes. These will be different if the metric tensor is not the identity (e.g. if with curvilinear coordinates like angle-axis).</p></body></html>",
                None,
                QtGui.QApplication.UnicodeUTF8,
            )
        )
