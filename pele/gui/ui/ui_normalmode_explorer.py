...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(
            self.pushClose, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.close
        )
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QtGui.QApplication.translate(
                "MainWindow", "Normalmode Browser", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.label.setText(
            QtGui.QApplication.translate(
        ...
        self.actionRun.setText(
            QtGui.QApplication.translate(
                "MainWindow", "Play", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        ...
        self.actionShow_energies.setText(
            QtGui.QApplication.translate(
                "MainWindow", "show energies", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.actionShow_energies.setToolTip(
            QtGui.QApplication.translate(
                "MainWindow",
                "<html><head/><body><p>Show a plot of the energies.  Note the energy"
                " will only agree with the harmonic approximation if the metric tensor"
                " is the identity.  Click the button &quot;Hessian eigs&quot; to make"
                " the energies agree.</p></body></html>",
                None,
                QtGui.QApplication.UnicodeUTF8,
            )
        )
        self.actionHessian_eigs.setText(
            QtGui.QApplication.translate(
                "MainWindow", "Hessian eigs", None, QtGui.QApplication.UnicodeUTF8
            )
        )
        self.actionHessian_eigs.setToolTip(
            QtGui.QApplication.translate(
                "MainWindow",
                "<html><head/><body><p>Show the Hessian eigenvalues and eigenvectors"
                " instead of the normal modes. These will be different if the metric"
                " tensor is not the identity (e.g. if with curvilinear coordinates like"
                " angle-axis).</p></body></html>",
                None,
                QtGui.QApplication.UnicodeUTF8,
            )
        )
