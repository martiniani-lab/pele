...
def test_combined_potentials_energy_gradient_hessian():
    ...
    energy, gradient, hessian = combined_potential.getEnergyGradientHessian(
        test_coords
    )

    energy_a, gradient_a, hessian_a = potential_a.getEnergyGradientHessian(
        test_coords
    )
    energy_b, gradient_b, hessian_b = potential_b.getEnergyGradientHessian(
        test_coords
    )
