...
class Test2dMinimization(unittest.TestCase):
    def setUp(self):
        ...
        self.nr_particles_frozen = (
            self.nr_particles_total - self.nr_particles_mobile
        )
        ...
        self.radii = np.asarray(
            [
                ...
                for _ in range(self.nr_particles_total)
            ]
        )
        self.sca = 1
    ...
    def test_minimization(self):
        ...
        self.assertAlmostEqual(
            self.res_NY.energy, self.res_YY.energy, delta=1e-10
        )
        self.assertAlmostEqual(
