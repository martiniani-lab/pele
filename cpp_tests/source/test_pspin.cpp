...
public:
  ...
  virtual void setup_potential() {
    pot = std::shared_ptr<pele::BasePotential>(
        new MeanFieldPSpinSpherical<4>(interactions, n, tol));
  }
...
public:
  ...
  virtual void setup_potential() {
    pot = std::shared_ptr<pele::BasePotential>(
        new MeanFieldPSpinSpherical<2>(interactions, n, tol));
  }
...
TEST_F(MeanFieldPSpinSphericalTestP4, Energy_Works) { test_energy(); }

TEST_F(MeanFieldPSpinSphericalTestP4, EnergyGradient_AgreesWithNumerical) {
  test_energy_gradient();
}

TEST_F(MeanFieldPSpinSphericalTestP4,
       EnergyGradientHessian_AgreesWithNumerical) {
  test_energy_gradient_hessian();
}

TEST_F(MeanFieldPSpinSphericalTestP4_2, Energy_Works) { test_energy(); }

TEST_F(MeanFieldPSpinSphericalTestP4_2, EnergyGradient_AgreesWithNumerical) {
  test_energy_gradient();
}

TEST_F(MeanFieldPSpinSphericalTestP4_2,
       EnergyGradientHessian_AgreesWithNumerical) {
  test_energy_gradient_hessian();
}

TEST_F(MeanFieldPSpinSphericalTestP2, Energy_Works) { test_energy(); }

TEST_F(MeanFieldPSpinSphericalTestP2, EnergyGradient_AgreesWithNumerical) {
  test_energy_gradient();
}

TEST_F(MeanFieldPSpinSphericalTestP2,
       EnergyGradientHessian_AgreesWithNumerical) {
  test_energy_gradient_hessian();
}

TEST_F(MeanFieldPSpinSphericalTestP2_2, Energy_Works) { test_energy(); }

TEST_F(MeanFieldPSpinSphericalTestP2_2, EnergyGradient_AgreesWithNumerical) {
  test_energy_gradient();
}

TEST_F(MeanFieldPSpinSphericalTestP2_2,
       EnergyGradientHessian_AgreesWithNumerical) {
  test_energy_gradient_hessian();
}
