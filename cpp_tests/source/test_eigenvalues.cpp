...
void setup() {
    ...
    std::shared_ptr<pele::LowestEigPotential> lep_ptr = std::make_shared<pele::LowestEigPotential>(lep);


    std::shared_ptr<pele::LBFGS> lbfgs = std::shared_ptr<pele::LBFGS> (new pele::LBFGS(lep_ptr, x, 1e-6, 10));
