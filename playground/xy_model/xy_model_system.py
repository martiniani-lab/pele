...
class XYModlelSystem(BaseSystem):
    ...
    def setup_params(self, params):
        ...
        params.double_ended_connect.local_connect_params.NEBparams.image_density = 0.8
        params.double_ended_connect.local_connect_params.NEBparams.iter_density = 50.0
