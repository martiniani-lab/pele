...
class ColdFusionCheck(potential):
    ...
    def __init__(
        self, potential, coldfusionlimit=-1000, coldfusionenergy=1000000
    ):
...
def addColdFusionCheck(
    basinhopping, coldfusionlimit=-1000, coldfusionenergy=1000000
):
    pot = basinhopping.potential
    cfPot = ColdFusionCheck(
        pot, coldfusionlimit=coldfusionlimit, coldfusionenergy=coldfusionenergy
    )
